    ...
    int const right)
{
    ...
    // Создраю временные массивы
    int* leftArray = new int[subArrayOne];
    int* rightArray = new int[subArrayTwo];

    // Копирую данные во временные массивы
    for (int i = 0; i < subArrayOne; i++)
        leftArray[i] = array[left + i];
    for (int j = 0; j < subArrayTwo; j++)
        rightArray[j] = array[mid + 1 + j];

    int indexOfSubArrayOne = 0; // начальный индекс первого под-массива
    int indexOfSubArrayTwo = 0; // начальный индекс второго под-массива
    int indexOfMergedArray = left; // начальный индекс соединенного массива 

    // соединяет два временных массива в один
...
/* массив разбивается на отсортированные массивы, пока не будут элемент  */
...
int binarySearch(int* arr, int start, int end, int x)
{
    if (start <= end) {
        ...
        if (arr[mid] == x) // если центральный элемент и есть число x
            return 1;
        if (arr[mid] > x) // если центр. элемент больше x, то число x находится слева
            return binarySearch(arr, start, mid - 1, x);
        return binarySearch(arr, mid + 1, end, x); // значит центр. элемент больше x, то есть число x находится справа
    }
    return -1;
}
int answer = 0;
    ...
    while (true) {
        ...
        answer = int(ch) - 48;
            ...
            case 1:
                ...
                break;
            case 2:
                cout << "Выберите тип сортировки:" << endl << "1. Bubble sort" << endl << "2. Shaker sort" << endl << "3. Insertion sort" << endl << "4. Comb sort" << endl << "5. Quick sort" << endl << "6. Merge sort" << endl;
                cin >> answer;
                switch (answer)
                {
                case 1:
